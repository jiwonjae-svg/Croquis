...
class MainWindow(QMainWindow):
    ...
    def apply_dark_mode(self):
        ...
        Note: Now using global QSS stylesheet (style.qss) instead of inline styles.
        This method is kept for backward compatibility but does nothing.
        """
        # QSS stylesheet is loaded at application level in main()
        pass
    ...
    def on_dark_mode_changed(self, state: int):
        ...
        # Note: Dark mode is now always on via QSS, this setting is kept for compatibility
        self.save_settings()
    ...
    def load_settings(self):
        ...
        if settings_path.exists():
            try:
                ...
                # Don't save during initialization - will be saved on first change
        else:
    ...
    def save_settings(self):
        """Persist settings to disk and update AppState."""
